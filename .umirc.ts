...
const repo = 'Ti-comment'; // 项目名(也就是你的仓库名)

export default defineConfig({
  title: 'Ti-comment', // 你的组件库名字
  // 你的网站 tabs 图片
  ...
  navs: [
    null,
    {
      ...
      children: [
        {
          title: 'CSDN',
          path: 'https://blog.csdn.net/cgh508802602?spm=1000.2115.3001.5343',
        },
        {
          title: '掘金',
          path: 'https://juejin.cn/user/4086253037818823',
        },
      ],
    },
    {
